...
namespace StardewValley.Quests
{
	public class ResourceCollectionQuest : Quest
	{
		...
		public void loadQuestInfo()
		{
			...
			{
				num = Math.Max(num, allFarmer.MiningLevel);
			}
			foreach (Farmer allFarmer2 in Game1.getAllFarmers())
			{
				num2 = Math.Max(num2, allFarmer2.ForagingLevel);
			}
			...
			case 0:
				...
				number.Value = 20 + num * 2 + random.Next(-2, 4) * 2;
			...
			case 2:
				resource.Value = 380;
				deliveryItem.Value = new Object(Vector2.Zero, resource, 1);
				number.Value = 15 + num + random.Next(-1, 3) * 2;
			...
			case 4:
				resource.Value = 382;
				deliveryItem.Value = new Object(Vector2.Zero, resource, 1);
				number.Value = 10 + num + random.Next(-1, 3) * 2;
			...
			case 6:
				...
				deliveryItem.Value = new Object(Vector2.Zero, resource, 1);
				number.Value = 8 + num / 2 + random.Next(-1, 1) * 2;
			...
			case 10:
				resource.Value = 390;
				deliveryItem.Value = new Object(Vector2.Zero, resource, 1);
				number.Value = 25 + num + random.Next(-3, 3) * 2;
				number.Value = (int)number - (int)number % 5;
				reward.Value = (int)number * 8;
				target.Value = "Robin";
				break;
			...
			if ((int)resource < 388)
			{
				...
				parts.Add(new DescriptionElement("Strings\\StringsFromCSFiles:ResourceCollectionQuest.cs.13647", number.Value, deliveryItem.Value, new DescriptionElement[4] { "Strings\\StringsFromCSFiles:ResourceCollectionQuest.cs.13649", "Strings\\StringsFromCSFiles:ResourceCollectionQuest.cs.13650", "Strings\\StringsFromCSFiles:ResourceCollectionQuest.cs.13651", "Strings\\StringsFromCSFiles:ResourceCollectionQuest.cs.13652" }.ElementAt(num3)));
				if (num3 == 3)
				{
					dialogueparts.Clear();
