	...
	public class FishingQuest : Quest
	{
		...
		public void loadQuestInfo()
		{
			...
			if (random.NextDouble() < 0.5)
			{
				...
				case "spring":
				{
					int[] array = new int[8] { 129, 131, 136, 137, 142, 143, 145, 147 };
					whichFish.Value = array[random.Next(array.Length)];
					break;
				}
				case "summer":
				{
					int[] array = new int[10] { 130, 131, 136, 138, 142, 144, 145, 146, 149, 150 };
					whichFish.Value = array[random.Next(array.Length)];
					break;
				}
				case "fall":
				{
					int[] array = new int[8] { 129, 131, 136, 137, 139, 142, 143, 150 };
					whichFish.Value = array[random.Next(array.Length)];
					break;
				}
				case "winter":
				{
					int[] array = new int[9] { 130, 131, 136, 141, 144, 146, 147, 150, 151 };
					whichFish.Value = array[random.Next(array.Length)];
					break;
				}
				}
			...
			else
			{
				...
				case "spring":
				{
					int[] array2 = new int[9] { 129, 131, 136, 137, 142, 143, 145, 147, 702 };
					whichFish.Value = array2[random.Next(array2.Length)];
					break;
				}
				case "summer":
				{
					...
					{
						128, 130, 131, 136, 138, 142, 144, 145, 146, 149,
						150, 702
					};
					whichFish.Value = array2[random.Next(array2.Length)];
					break;
				...
				case "fall":
				{
					...
					{
						129, 131, 136, 137, 139, 142, 143, 150, 699, 702,
						705
					};
					whichFish.Value = array2[random.Next(array2.Length)];
					break;
				...
				case "winter":
				{
					...
					{
						130, 131, 136, 141, 143, 144, 146, 147, 150, 151,
						699, 702, 705
					};
					whichFish.Value = array2[random.Next(array2.Length)];
					break;
				...
				dialogueparts.Add(new DescriptionElement[4]
				{
					...
					new DescriptionElement("Strings\\StringsFromCSFiles:FishingQuest.cs.13260", new DescriptionElement[6] { "Strings\\StringsFromCSFiles:FishingQuest.cs.13261", "Strings\\StringsFromCSFiles:FishingQuest.cs.13262", "Strings\\StringsFromCSFiles:FishingQuest.cs.13263", "Strings\\StringsFromCSFiles:FishingQuest.cs.13264", "Strings\\StringsFromCSFiles:FishingQuest.cs.13265", "Strings\\StringsFromCSFiles:FishingQuest.cs.13266" }.ElementAt(random.Next(6))),
