	...
	public class Stable : Building
	{
		...
		public override void draw(SpriteBatch b)
		{
			if (!base.isMoving)
			{
				...
				drawShadow(b);
				b.Draw(texture.Value, Game1.GlobalToLocal(Game1.viewport, new Vector2((int)tileX * 64, (int)tileY * 64 + (int)tilesHigh * 64)), texture.Value.Bounds, color.Value * alpha, 0f, new Vector2(0f, 96f), 4f, SpriteEffects.None, (float)(((int)tileY + (int)tilesHigh - 1) * 64) / 10000f);
			}
		}
	}
}
