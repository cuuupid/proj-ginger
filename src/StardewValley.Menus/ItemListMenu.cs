...
namespace StardewValley.Menus
{
	public class ItemListMenu : IClickableMenu
	{
		...
		public ItemListMenu(string menuTitle, List<Item> itemList)
		{
			...
			int num2 = 96;
			int num3 = num + num2 + 8;
			int num4 = Game1.uiViewport.Width / 2;
			int num5 = Game1.uiViewport.Height / 2;
			...
			xPositionOnScreen = num4 - width / 2;
			yPositionOnScreen = num5 - height / 2;
			Rectangle bounds = new Rectangle(num4 + width / 2 - 16 - 80, num5 + height / 2 - 16 - 80, 80, 80);
