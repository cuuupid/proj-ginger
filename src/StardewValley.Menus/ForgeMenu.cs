...
namespace StardewValley.Menus
{
	public class ForgeMenu : MenuWithInventory
	{
		...
		public override void draw(SpriteBatch b)
		{
			...
			int num = forgePosX + IClickableMenu.spaceToClearSideBorder + IClickableMenu.borderWidth / 2 - 4;
			int num2 = forgePosY + IClickableMenu.spaceToClearTopBorder;
			num2 = forgePosY;
			Game1.DrawBox(num, num2, 568, 320, value);
			b.Draw(forgeTextures, new Vector2(num, num2), new Rectangle(0, 0, 142, 80), Color.White, 0f, Vector2.Zero, 4f, SpriteEffects.None, 0.87f);
			num += 552;
			Game1.DrawBox(num, num2, 426, 320, value);
			drawDescriptionArea(b, num, num2, value.R, value.G, value.B);
