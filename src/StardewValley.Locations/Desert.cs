...
namespace StardewValley.Locations
{
	public class Desert : GameLocation
	{
		...
		internal Microsoft.Xna.Framework.Rectangle desertMerchantBounds = new Microsoft.Xna.Framework.Rectangle(2112, 1280, 836, 280);
		...
		public static Dictionary<ISalable, int[]> getDesertMerchantTradeStock(Farmer who)
		{
			...
			Item key = new Object(275, 1);
			dictionary.Add(key, new int[4] { 0, 2147483647, 749, 5 });
			key = new Object(261, 1);
			dictionary.Add(key, new int[4] { 0, 2147483647, 749, 3 });
			key = new Object(253, 1);
			dictionary.Add(key, new int[4] { 0, 2147483647, 72, 1 });
			key = new Object(226, 1);
			dictionary.Add(key, new int[4] { 0, 2147483647, 64, 1 });
			key = new Object(288, 1);
			dictionary.Add(key, new int[4] { 0, 2147483647, 386, 5 });
			key = new Object(287, 1);
			dictionary.Add(key, new int[4] { 0, 2147483647, 80, 5 });
			if (Game1.dayOfMonth % 7 == 0)
			{
				key = new Object(Vector2.Zero, 71);
				dictionary.Add(key, new int[4] { 0, 2147483647, 70, 1 });
			}
			if (Game1.dayOfMonth % 7 == 1)
			{
				key = new Object(178, 3);
				dictionary.Add(key, new int[4] { 0, 2147483647, 749, 1 });
			}
			if (Game1.dayOfMonth % 7 == 2)
			{
				key = new Object(771, 1);
				dictionary.Add(key, new int[4] { 0, 2147483647, 390, 5 });
			}
			if (Game1.dayOfMonth % 7 == 3)
			{
				key = new Object(428, 1);
				dictionary.Add(key, new int[4] { 0, 2147483647, 62, 3 });
			}
			if (Game1.dayOfMonth % 7 == 4 && !boughtMagicRockCandy)
			{
				key = new Object(279, 1);
				dictionary.Add(key, new int[4] { 0, 1, 74, 3 });
			}
			if (Game1.dayOfMonth % 7 == 5)
			{
				key = new Object(424, 1);
				dictionary.Add(key, new int[4] { 0, 2147483647, 60, 1 });
			}
			if (Game1.dayOfMonth % 7 == 6)
			{
				key = new Object(495, 1);
				dictionary.Add(key, new int[4] { 0, 2147483647, 496, 2 });
				key = new Object(496, 1);
				dictionary.Add(key, new int[4] { 0, 2147483647, 497, 2 });
				key = new Object(497, 1);
				dictionary.Add(key, new int[4] { 0, 2147483647, 498, 2 });
				key = new Object(498, 1);
				dictionary.Add(key, new int[4] { 0, 2147483647, 495, 2 });
			}
			if (who != null && !who.craftingRecipes.ContainsKey("Warp Totem: Desert"))
			{
				key = new Object(261, 1, isRecipe: true);
				dictionary.Add(key, new int[4] { 0, 1, 337, 10 });
			}
			...
			{
				key = new Object(808, 1);
				dictionary.Add(key, new int[4] { 0, 1, 769, 200 });
			}
			key = new Furniture(1971, Vector2.Zero);
			dictionary.Add(key, new int[4] { 0, 2147483647, 767, 200 });
			key = new Hat(72);
			dictionary.Add(key, new int[4] { 0, 2147483647, 749, 50 });
			key = new Hat(73);
			if (Game1.stats.DaysPlayed % 2u == 0)
			{
				key = new Hat(74);
			}
			dictionary.Add(key, new int[4] { 0, 2147483647, 749, 333 });
			key = new BedFurniture(2508, Vector2.Zero);
			dictionary.Add(key, new int[4] { 0, 2147483647, 797, 1 });
			return dictionary;
		}
