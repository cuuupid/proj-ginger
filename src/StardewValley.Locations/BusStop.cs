...
namespace StardewValley.Locations
{
	public class BusStop : GameLocation
	{
		...
		public override bool answerDialogue(Response answer)
		{
			if (lastQuestionKey != null && afterQuestion == null)
			{
				...
				if (text == "Bus_Yes")
				{
					...
					if (Game1.player.Money >= (Game1.shippingTax ? 50 : 500) && characters.Contains(characterFromName) && characterFromName.getTileLocation().Equals(new Vector2(11f, 10f)))
					{
		...
		public override void drawAboveAlwaysFrontLayer(SpriteBatch b)
		{
			...
			Vector2 vector = Game1.GlobalToLocal(Game1.viewport, new Vector2(0f, -100f));
			b.Draw(Game1.fadeToBlackRect, new Microsoft.Xna.Framework.Rectangle((int)vector.X, (int)vector.Y, map.DisplayWidth, 100), Color.Black);
		}
