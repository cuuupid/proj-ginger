...
namespace StardewValley.Locations
{
	public class IslandSouthEast : IslandLocation
	{
		...
		public override void UpdateWhenCurrentLocation(GameTime time)
		{
			...
			if (flag && (currentMermaidAnimation == null || currentMermaidAnimation == mermaidIdle))
			{
			...
			else
			{
				...
				else if (!flag && currentMermaidAnimation == mermaidWave)
				{
					currentMermaidAnimation = mermaidIdle;
				}
			}
		...
		public override void draw(SpriteBatch b)
		{
			...
			if (MermaidIsHere())
			{
				...
				{
					num = currentMermaidAnimation[mermaidFrameIndex];
				}
				b.Draw(mermaidSprites, Game1.GlobalToLocal(new Vector2(32f, 32f) * 64f + new Vector2(0f, -8f) * 4f), new Microsoft.Xna.Framework.Rectangle(304 + 28 * num, 592, 28, 36), Color.White, 0f, Vector2.Zero, 4f, SpriteEffects.None, 0.0009f);
			}
		}
		...
		public void OnFishWalnut()
		{
			...
			{
				Vector2 vector = new Vector2(19f, 21f);
				Game1.createItemDebris(new Object(73, 1), vector * 64f + new Vector2(0.5f, 1.5f) * 64f, 0, this, 0);
				Game1.multiplayer.broadcastSprites(this, new TemporaryAnimatedSprite(28, 100f, 2, 1, vector * 64f, flicker: false, flipped: false)
				{
					layerDepth = ((vector.Y + 0.5f) * 64f + 2f) / 10000f
				});
