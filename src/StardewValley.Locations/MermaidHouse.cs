...
namespace StardewValley.Locations
{
	public class MermaidHouse : GameLocation
	{
		...
		public override void UpdateWhenCurrentLocation(GameTime time)
		{
			...
			{
				if (stopWatch != null && !stopWatch.IsRunning && cue != null && cue.Name.Equals("mermaidSong") && cue.IsPaused)
				{
					stopWatch.Start();
				}
			...
			if (Game1.shouldTimePass())
			{
				...
				if (((cue != null && cue.Name.Equals("mermaidSong") && cue.IsPlaying) || (Game1.options.musicVolumeLevel <= 0f && Game1.options.ambientVolumeLevel <= 0f)) && !stopWatch.IsRunning)
				{
					stopWatch.Start();
				}
				...
				for (int num3 = alwaysFrontTempSprites.Count - 1; num3 >= 0; num3--)
				{
					if (alwaysFrontTempSprites[num3].update(time))
					{
						alwaysFrontTempSprites.RemoveAt(num3);
					}
				}
