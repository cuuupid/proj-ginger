...
namespace StardewValley.Locations
{
	public class BeachNightMarket : GameLocation
	{
		...
		public override bool answerDialogueAction(string questionAndAnswer, string[] questionParams)
		{
			...
			case "WarperQuestion_Yes":
				...
				else
				{
					...
					Object @object = new Object(688, 1);
					@object.performUseAction(this);
		...
		public Dictionary<ISalable, int[]> getBlueBoatStock()
		{
			...
			dictionary.Add(new Object(Vector2.Zero, 40), new int[2] { 200, 2147483647 });
			dictionary.Add(new Object(Vector2.Zero, 41), new int[2] { 200, 2147483647 });
			dictionary.Add(new Object(Vector2.Zero, 42), new int[2] { 200, 2147483647 });
			dictionary.Add(new Object(Vector2.Zero, 43), new int[2] { 200, 2147483647 });
			dictionary.Add(new Object(Vector2.Zero, 44), new int[2] { 200, 2147483647 });
			dictionary.Add(new Furniture(2397, Vector2.Zero), new int[2] { 800, 2147483647 });
			dictionary.Add(new Furniture(2398, Vector2.Zero), new int[2] { 800, 2147483647 });
			dictionary.Add(new Furniture(1975, Vector2.Zero), new int[2] { 1000, 2147483647 });
			dictionary.Add(new Object(Vector2.Zero, 48), new int[2] { 500, 2147483647 });
			dictionary.Add(new Object(Vector2.Zero, 184), new int[2] { 500, 2147483647 });
			dictionary.Add(new Object(Vector2.Zero, 188), new int[2] { 500, 2147483647 });
			dictionary.Add(new Object(Vector2.Zero, 192), new int[2] { 500, 2147483647 });
			dictionary.Add(new Object(Vector2.Zero, 196), new int[2] { 500, 2147483647 });
			dictionary.Add(new Object(Vector2.Zero, 200), new int[2] { 500, 2147483647 });
			dictionary.Add(new Object(Vector2.Zero, 204), new int[2] { 500, 2147483647 });
			return dictionary;
		}
		...
		public Dictionary<ISalable, int[]> geMagicShopStock()
		{
			...
			case 2:
				...
				if (Game1.year > 1)
				{
					dictionary.Add(new Object(485, 1), new int[2]
					{
			...
			case 3:
				...
				if (Game1.year > 1)
				{
					dictionary.Add(new Object(489, 1), new int[2]
					{
			...
			if (num2 >= 20)
			{
				dictionary.Add(new Object(Vector2.Zero, 139), new int[2] { 5000, 2147483647 });
			}
			if (num + num2 >= 40)
			{
				dictionary.Add(new Object(Vector2.Zero, 140), new int[2] { 5000, 2147483647 });
			}
			return dictionary;
		}
	}
