...
namespace StardewValley.Locations
{
	public class FarmCave : GameLocation
	{
		...
		public override void DayUpdate(int dayOfMonth)
		{
			...
			if ((int)Game1.MasterPlayer.caveChoice == 1)
			{
				while (Game1.random.NextDouble() < 0.66)
				{
					...
					{
						setObject(v, new Object(parentSheetIndex, 1)
						{
		...
		public virtual void UpdateReadyFlag()
		{
			...
			{
				if ((bool)value2.isSpawnedObject)
				{
					value = true;
					break;
				}
				if ((bool)value2.bigCraftable && value2.heldObject.Value != null && (int)value2.minutesUntilReady <= 0 && value2.ParentSheetIndex == 128)
				{
					value = true;
					break;
				}
