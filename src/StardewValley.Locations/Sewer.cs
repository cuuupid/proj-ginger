...
namespace StardewValley.Locations
{
	public class Sewer : GameLocation
	{
		...
		private Dictionary<ISalable, int[]> generateKrobusStock()
		{
			...
			dictionary.Add(new Object(769, 1), new int[2] { 100, 10 });
			dictionary.Add(new Object(768, 1), new int[2] { 80, 10 });
			Random random = new Random((int)Game1.stats.DaysPlayed + (int)Game1.uniqueIDForThisGame / 2);
			switch (Game1.dayOfMonth % 7)
			{
			case 0:
				dictionary.Add(new Object(767, 1), new int[2] { 30, 10 });
				break;
			case 1:
				dictionary.Add(new Object(766, 1), new int[2] { 10, 50 });
				break;
			case 2:
				dictionary.Add(new Object(749, 1), new int[2] { 300, 1 });
				break;
			case 3:
				dictionary.Add(new Object(random.Next(698, 709), 1), new int[2] { 200, 5 });
				break;
			case 4:
				dictionary.Add(new Object(770, 1), new int[2] { 30, 10 });
				break;
			case 5:
				dictionary.Add(new Object(645, 1), new int[2] { 10000, 1 });
				break;
			case 6:
			{
				...
				dictionary.Add(new Object(num, 1), new int[2]
				{
					random.Next(5, 51) * 10,
					5
				});
			...
			dictionary.Add(new Object(305, 1), new int[2] { 5000, 2147483647 });
			dictionary.Add(new Object(Vector2.Zero, 34), new int[2] { 350, 2147483647 });
			dictionary.Add(new Furniture(1800, Vector2.Zero), new int[2] { 20000, 2147483647 });
			return dictionary;
		}

		public Dictionary<ISalable, int[]> getShadowShopStock()
		{
			Dictionary<ISalable, int[]> dictionary = generateKrobusStock();
			SynchronizedShopStock synchronizedShopStock = Game1.player.team.synchronizedShopStock;
			synchronizedShopStock.UpdateLocalStockWithSyncedQuanitities(SynchronizedShopStock.SynchedShop.Krobus, dictionary);
			if (!Game1.player.hasOrWillReceiveMail("CF_Sewer"))
			{
				Item key = new Object(434, 1);
				dictionary.Add(key, new int[2] { 20000, 1 });
			}
			if (!Game1.player.craftingRecipes.ContainsKey("Crystal Floor"))
			{
				Item item = new Object(333, 1, isRecipe: true);
				dictionary.Add(new Object(333, 1, isRecipe: true), new int[2] { 500, 1 });
			}
			if (!Game1.player.craftingRecipes.ContainsKey("Wicked Statue"))
			{
				Item key2 = new Object(Vector2.Zero, 83, isRecipe: true);
				dictionary.Add(key2, new int[2] { 1000, 1 });
			}
			if (!Game1.player.hasOrWillReceiveMail("ReturnScepter"))
			{
				Item key3 = new Wand();
				dictionary.Add(key3, new int[2] { 2000000, 1 });
			}
			return dictionary;
		}
		...
		{
			SynchronizedShopStock synchronizedShopStock = Game1.player.team.synchronizedShopStock;
			synchronizedShopStock.OnItemPurchased(SynchronizedShopStock.SynchedShop.Krobus, item, amount);
			return false;
		}
		...
		public override Object getFish(float millisecondsAfterNibble, int bait, int waterDepth, Farmer who, double baitPotency, Vector2 bobberTile, string locationName = null)
		{
			...
			if (Game1.random.NextDouble() < 0.1 + (double)num + ((who.getTileX() > 14 && who.getTileY() > 42) ? 0.08 : 0.0))
			{
