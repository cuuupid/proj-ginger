...
namespace StardewValley.Locations
{
	public class IslandFieldOffice : IslandLocation
	{
			...
			if (questionAndAnswer != null)
			{
				...
				case 11:
					if (questionAndAnswer == "Safari_Hint")
					{
						...
						Game1.drawDialogue(safariGuy, Game1.content.LoadString("Data\\ExtraDialogue:ProfessorSnail_Hint_" + num));
					}
					break;
				case 14:
					if (questionAndAnswer == "Safari_Collect")
					{
						Game1.activeClickableMenu = new ItemGrabMenu(new List<Item>(uncollectedRewards), reverseGrab: false, showReceivingMenu: true, null, null, "Rewards", OnCollectReward, snapToBottom: false, canBeExitedWithKey: true, playRightClickSound: false, allowRightClick: false, showOrganizeButton: false, 0, null, -1, null, -1, 3, null, allowStack: true, null, rearrangeGrangeOnExit: false, null, this);
		...
		public virtual void TalkToSafariGuy()
		{
			...
			int randomUnfoundBoneIndex = getRandomUnfoundBoneIndex();
			if (randomUnfoundBoneIndex != -1)
			{
		...
		public override bool performAction(string action, Farmer who, Location tileLocation)
		{
			...
			else if (action == "FieldOfficeSurvey" && safariGuy != null)
			{
				...
				{
					List<Response> list = new List<Response>();
					list.Add(new Response("Yes", Game1.content.LoadString("Strings\\Locations:IslandFieldOffice_Survey_Yes")));
					list.Add(new Response("No", Game1.content.LoadString("Strings\\Locations:IslandFieldOffice_Survey_Notyet")));
					createQuestionDialogue(Game1.content.LoadString("Strings\\Locations:IslandFieldOffice_Survey_Prompt_LeftPlant"), list.ToArray(), "Survey");
				...
				{
					List<Response> list2 = new List<Response>();
					list2.Add(new Response("Yes", Game1.content.LoadString("Strings\\Locations:IslandFieldOffice_Survey_Yes")));
					list2.Add(new Response("No", Game1.content.LoadString("Strings\\Locations:IslandFieldOffice_Survey_Notyet")));
					createQuestionDialogue(Game1.content.LoadString("Strings\\Locations:IslandFieldOffice_Survey_Prompt_RightPlant"), list2.ToArray(), "Survey");
