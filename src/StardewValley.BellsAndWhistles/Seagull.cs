			...
			case 3:
				if (Game1.random.NextDouble() < 0.003 && sprite.CurrentAnimation == null)
				{
					...
					case 0:
					{
						...
						for (int j = 0; j < num; j++)
						{
							list.Add(new FarmerSprite.AnimationFrame((short)(baseFrame + 4), 200));
							list.Add(new FarmerSprite.AnimationFrame((short)(baseFrame + 5), 200));
						}
					...
					case 2:
					{
						...
						for (int i = 0; i < num; i++)
						{
							list.Add(new FarmerSprite.AnimationFrame((short)(baseFrame + 7), 100));
							list.Add(new FarmerSprite.AnimationFrame((short)(baseFrame + 8), 100));
						}
						sprite.setCurrentAnimation(list);
						break;
					}
