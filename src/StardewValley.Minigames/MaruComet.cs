...
namespace StardewValley.Minigames
{
	public class MaruComet : IMinigame
	{
		...
		public void draw(SpriteBatch b)
		{
			...
			SpriteText.drawStringHorizontallyCenteredAt(b, currentString, (int)centerOfScreen.X, (int)num2, currentStringCharacter, -1, 99999, 1f, 0.99f, junimoText: false, 3, Game1.game1.localMultiplayerWindow.Width);
