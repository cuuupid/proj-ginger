...
namespace StardewValley.Minigames
{
	public class FantasyBoardGame : IMinigame
	{
		...
		public void receiveLeftClick(int x, int y, bool playSound = true)
		{
			if (Game1.activeClickableMenu != null)
			{
				y = (int)((float)y * ((float)Game1.uiViewport.Height / (float)Game1.viewport.Height));
				x = (int)((float)x * ((float)Game1.uiViewport.Width / (float)Game1.viewport.Width));
				Game1.PushUIMode();
		...
		public void releaseLeftClick(int x, int y)
		{
			if (Game1.activeClickableMenu != null)
			{
				...
				x = (int)((float)x * ((float)Game1.uiViewport.Width / (float)Game1.viewport.Width));
				Game1.PushUIMode();
				Game1.activeClickableMenu.releaseLeftClick(x, y);
				Game1.PopUIMode();
			}
		}
