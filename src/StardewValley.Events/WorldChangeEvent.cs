	...
	public class WorldChangeEvent : FarmEvent, INetObject<NetFields>
	{
		...
		public bool setUp()
		{
			...
			case 12:
			{
				...
				{
					location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", sourceRect, 9999f, 1, 999, position2, flicker: false, Game1.random.NextDouble() < 0.5, (vector.Y + 32f) / 10000f + 0.001f, 0.025f, Color.White, 4f, 0f, 0f, 0f)
					{
						light = true,
						lightRadius = 2f,
			...
			case 10:
				...
				soundInterval = 560;
				Game1.currentLightSources.Add(new LightSource(4, new Vector2(num, num2) * 64f, 4f, LightSource.LightContext.None, 0L));
				sound = "axchop";
				break;
			case 11:
				location = Game1.getLocationFromName("Town");
				...
				num = 95;
				num2 = 48;
				Utility.addSprinklesToLocation(location, num, num2, 7, 7, 15000, 150, Color.LightCyan);
				Utility.addStarsAndSpirals(location, num, num2, 7, 7, 15000, 150, Color.White);
				Game1.player.activeDialogueEvents.Add("movieTheater", 3);
				sound = "junimoMeep1";
				Game1.currentLightSources.Add(new LightSource(4, new Vector2(num, num2) * 64f, 4f, Color.DarkGoldenrod, LightSource.LightContext.None, 0L));
			...
			case 0:
				...
				if (location != null && location is Farm)
				{
					foreach (Building building in (location as Farm).buildings)
					{
						...
						{
							num = (int)building.tileX + 3;
							num2 = (int)building.tileY + 3;
							break;
						}
					}
				}
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(288, 1349, 19, 28), 150f, 5, 999, new Vector2((num - 3) * 64 + 8, (num2 - 1) * 64 - 32), flicker: false, flipped: false)
				{
					scale = 4f,
					layerDepth = 1f
				});
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(288, 1377, 19, 28), 140f, 5, 999, new Vector2((num + 3) * 64 - 16, (num2 - 2) * 64), flicker: false, flipped: false)
				{
					scale = 4f,
					layerDepth = 1f
				});
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(390, 1405, 18, 32), 1000f, 2, 999, new Vector2(num * 64 + 8, (num2 - 4) * 64), flicker: false, flipped: false)
				{
					scale = 4f,
					layerDepth = 1f
				});
			...
			case 1:
				...
				if (location != null && location is Farm)
				{
					foreach (Building building2 in (location as Farm).buildings)
					{
						if (building2 is GreenhouseBuilding)
						{
							num = (int)building2.tileX + 3;
							num2 = (int)building2.tileY + 3;
							break;
						}
					}
				}
				Utility.addSprinklesToLocation(location, num, num2 - 1, 7, 7, 15000, 150, Color.LightCyan);
				Utility.addStarsAndSpirals(location, num, num2 - 1, 7, 7, 15000, 150, Color.White);
				Game1.player.activeDialogueEvents.Add("cc_Greenhouse", 3);
				sound = "junimoMeep1";
				Game1.currentLightSources.Add(new LightSource(4, new Vector2(num, num2) * 64f, 4f, Color.DarkGoldenrod, LightSource.LightContext.None, 0L));
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(294, 1432, 16, 16), 300f, 4, 999, new Vector2(num * 64, (num2 - 1) * 64 - 64), flicker: false, flipped: false)
				{
					scale = 4f,
					layerDepth = 1f,
					xPeriodic = true,
			...
			case 7:
				...
				num = 14;
				num2 = 8;
				Utility.addSprinklesToLocation(location, num, num2, 9, 4, 10000, 200, Color.LightCyan, null, motionTowardCenter: true);
				Utility.addStarsAndSpirals(location, num, num2, 9, 4, 15000, 150, Color.White);
				sound = "junimoMeep1";
			...
			case 3:
				...
				num = 105;
				num2 = 79;
				Utility.addSprinklesToLocation(location, num + 1, num2, 6, 4, 15000, 350, Color.LightCyan);
				Utility.addStarsAndSpirals(location, num + 1, num2, 6, 4, 15000, 350, Color.White);
				Game1.player.activeDialogueEvents.Add("cc_Minecart", 7);
			...
			case 5:
				...
				num = 95;
				num2 = 27;
				Utility.addSprinklesToLocation(location, num, num2, 7, 4, 15000, 150, Color.LightCyan);
				Utility.addStarsAndSpirals(location, num + 1, num2, 7, 4, 15000, 350, Color.White);
			...
			case 9:
				...
				num = 48;
				num2 = 5;
				Utility.addSprinklesToLocation(location, num, num2, 4, 4, 15000, 350, Color.LightCyan);
				Utility.addStarsAndSpirals(location, num + 1, num2, 4, 4, 15000, 550, Color.White);
				...
				sound = "junimoMeep1";
				Game1.currentLightSources.Add(new LightSource(4, new Vector2(num, num2) * 64f, 1f, LightSource.LightContext.None, 0L));
				Game1.currentLightSources.Add(new LightSource(4, new Vector2(num, num2) * 64f, 1f, Color.DarkCyan, LightSource.LightContext.None, 0L));
				Game1.currentLightSources.Add(new LightSource(4, new Vector2(num, num2) * 64f, 4f, Color.DarkGoldenrod, LightSource.LightContext.None, 0L));
				soundInterval = 1000;
				break;
			case 14:
			{
				...
				for (int i = 0; i < 16; i++)
				{
					...
					TemporaryAnimatedSprite temporaryAnimatedSprite = new TemporaryAnimatedSprite("LooseSprites\\Cursors2", new Rectangle(49 + 16 * Game1.random.Next(3), 229, 16, 6), Utility.getRandomPositionInThisRectangle(r, Game1.random) * 64f, Game1.random.NextDouble() < 0.5, 0f, Color.White)
					{
					...
					temporaryAnimatedSprite = new TemporaryAnimatedSprite("LooseSprites\\Cursors2", new Rectangle(49 + 16 * Game1.random.Next(3), 229, 16, 6), Utility.getRandomPositionInThisRectangle(r, Game1.random) * 64f, Game1.random.NextDouble() < 0.5, 0f, Color.White)
					{
						motion = new Vector2(Game1.random.Next(-2, 3), -16f),
						acceleration = new Vector2(0f, 0.5f),
						rotationChange = (float)Game1.random.Next(-4, 5) * 0.05f,
			...
			Game1.viewport.X = Math.Max(0, Math.Min(location.map.DisplayWidth - Game1.viewport.Width, num * 64 - Game1.viewport.Width / 2));
			Game1.viewport.Y = Math.Max(0, Math.Min(location.map.DisplayHeight - Game1.viewport.Height, num2 * 64 - Game1.viewport.Height / 2));
			if (!location.IsOutdoors)
			{
				Game1.viewport.X = num * 64 - Game1.viewport.Width / 2;
