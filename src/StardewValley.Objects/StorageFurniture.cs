...
namespace StardewValley.Objects
{
	public class StorageFurniture : Furniture
	{
		...
		{
			Game1.activeClickableMenu = new ItemGrabMenu(heldItems, reverseGrab: false, showReceivingMenu: true, InventoryMenu.highlightAllItems, GrabItemFromInventory, null, GrabItemFromChest, snapToBottom: false, canBeExitedWithKey: true, playRightClickSound: true, allowRightClick: true, showOrganizeButton: true, 1, this, -1, null, -1, 3, null, allowStack: true, null, rearrangeGrangeOnExit: false, null, this)
			{
		...
		{
			for (int num = heldItems.Count - 1; num >= 0; num--)
			{
				if (heldItems[num] == null)
				{
		...
		public virtual void ShowShopMenu()
		{
			...
			{
				dictionary[item] = new int[2] { 0, 1 };
			}
			Game1.activeClickableMenu = new ShopMenu(dictionary, 0, null, onDresserItemWithdrawn, onDresserItemDeposited, GetShopMenuContext())
			{
				source = this,
				behaviorBeforeCleanup = delegate
				{
