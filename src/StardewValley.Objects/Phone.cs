...
namespace StardewValley.Objects
{
	...
	public class Phone : Object
	{
		...
		internal static bool _phoneSoundPlayed = false;
		...
		public override void draw(SpriteBatch spriteBatch, int x, int y, float alpha = 1f)
		{
			...
			spriteBatch.Draw(Game1.bigCraftableSpriteSheet, destinationRectangle, Object.getSourceRectForBigCraftable(base.ParentSheetIndex + 1), Color.White * alpha, 0f, Vector2.Zero, SpriteEffects.None, layerDepth);
		}
	}
}
