...
namespace StardewValley.Network
{
	public class BandwidthLogger
	{
		...
		public void Update()
		{
			double totalMilliseconds = (DateTime.Now - lastUpdateTime).TotalMilliseconds;
			if (totalMilliseconds > 1000.0)
			{
				lastBitsDownPerSecond = (double)bitsDownSinceLastUpdate / totalMilliseconds * 1000.0;
				lastBitsUpPerSecond = (double)bitsUpSinceLastUpdate / totalMilliseconds * 1000.0;
