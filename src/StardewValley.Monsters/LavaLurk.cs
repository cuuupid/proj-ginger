				...
				if (fireTimer > 0f)
				{
					...
					if (fireTimer <= 0f)
					{
						...
						if (targettedFarmer != null)
						{
							...
							BasicProjectile basicProjectile = new BasicProjectile(25, 10, 0, 3, (float)Math.PI / 16f, vector2.X, vector2.Y, vector, "", "", explode: false, damagesMonsters: false, base.currentLocation, this);
