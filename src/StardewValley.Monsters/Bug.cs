	...
	public class Bug : Monster
	{
		...
		public override void draw(SpriteBatch b)
		{
			if (!base.IsInvisible && Utility.isOnScreen(base.Position, 128))
			{
				...
				b.Draw(Sprite.Texture, getLocalPosition(Game1.viewport) + new Vector2(32f, yJumpOffset) + vector, Sprite.SourceRect, Color.White, rotation, new Vector2(8f, 16f), 4f, flip ? SpriteEffects.FlipHorizontally : SpriteEffects.None, Math.Max(0f, drawOnTop ? 0.991f : ((float)getStandingY() / 10000f)));
			}
		}
