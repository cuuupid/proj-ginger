		...
		public override List<Item> getExtraDropItems()
		{
			...
			if ((bool)cursedDoll && Game1.random.NextDouble() < 0.1429 && (bool)hauntedSkull)
			{
				...
				case 0:
					...
					case 0:
					{
						Clothing clothing = new Clothing(10);
						clothing.clothesColor.Value = Color.DimGray;
						list.Add(clothing);
						break;
					}
					case 1:
						list.Add(new Clothing(1004));
						break;
					case 2:
						list.Add(new Clothing(1014));
						break;
					case 3:
						list.Add(new Clothing(1263));
						break;
					case 4:
						list.Add(new Clothing(1262));
						break;
					case 5:
					{
						Clothing clothing = new Clothing(12);
						clothing.clothesColor.Value = Color.DimGray;
						list.Add(clothing);
						break;
					}
				...
				case 5:
					do
					{
						list.Add(new Object(768, 1));
						list.Add(new Object(769, 1));
					}
					while (Game1.random.NextDouble() < 0.33);
					break;
				case 6:
					list.Add(new Object(581, 1));
					break;
				case 7:
					list.Add(new Object(582, 1));
					break;
				case 8:
					list.Add(new Object(725, 1));
					break;
				case 9:
					list.Add(new Object(86, 1));
					break;
				case 10:
					if (Utility.doesMasterPlayerHaveMailReceivedButNotMailForTomorrow("ccVault"))
					{
						list.Add(new Object(275, 1));
					}
					else
					{
						list.Add(new Object(749, 1));
					}
					break;
				}
				return list;
		...
		public override void drawAboveAllLayers(SpriteBatch b)
		{
			...
			if ((bool)cursedDoll)
			{
				if ((bool)hauntedSkull)
				{
					...
					b.Draw(Sprite.Texture, getLocalPosition(Game1.viewport) + new Vector2(32 + Game1.random.Next(-6, 7), 32 + Game1.random.Next(-6, 7)) + vector2, Game1.getSourceRectForStandardTileSheet(Sprite.Texture, num * 2 + (((bool)seenPlayer && Game1.currentGameTime.TotalGameTime.TotalMilliseconds % 500.0 < 250.0) ? 1 : 0), 16, 16), Color.Red * 0.44f, 0f, new Vector2(8f, 16f), Math.Max(0.2f, scale) * 4f, flip ? SpriteEffects.FlipHorizontally : SpriteEffects.None, (position.Y + 128f - 1f) / 10000f);
					b.Draw(Sprite.Texture, getLocalPosition(Game1.viewport) + new Vector2(32 + Game1.random.Next(-6, 7), 32 + Game1.random.Next(-6, 7)) + vector2, Game1.getSourceRectForStandardTileSheet(Sprite.Texture, num * 2 + (((bool)seenPlayer && Game1.currentGameTime.TotalGameTime.TotalMilliseconds % 500.0 < 250.0) ? 1 : 0), 16, 16), Color.Yellow * 0.44f, 0f, new Vector2(8f, 16f), Math.Max(0.2f, scale) * 4f, flip ? SpriteEffects.FlipHorizontally : SpriteEffects.None, (position.Y + 128f) / 10000f);
					if ((bool)seenPlayer)
					{
						for (int num2 = previousPositions.Count - 1; num2 >= 0; num2 -= 2)
						{
							b.Draw(Sprite.Texture, new Vector2(previousPositions[num2].X - (float)Game1.viewport.X, previousPositions[num2].Y - (float)Game1.viewport.Y + (float)yJumpOffset) + drawOffset + new Vector2(32f, 32f) + vector2, Game1.getSourceRectForStandardTileSheet(Sprite.Texture, num * 2 + (((bool)seenPlayer && Game1.currentGameTime.TotalGameTime.TotalMilliseconds % 500.0 < 250.0) ? 1 : 0), 16, 16), Color.White * (0f + 0.125f * (float)num2), 0f, new Vector2(8f, 16f), Math.Max(0.2f, scale) * 4f, flip ? SpriteEffects.FlipHorizontally : SpriteEffects.None, (position.Y + 128f - (float)num2) / 10000f);
						}
					}
					b.Draw(Sprite.Texture, getLocalPosition(Game1.viewport) + new Vector2(32f, 32f) + vector2, Game1.getSourceRectForStandardTileSheet(Sprite.Texture, num * 2 + (((bool)seenPlayer && Game1.currentGameTime.TotalGameTime.TotalMilliseconds % 500.0 < 250.0) ? 1 : 0), 16, 16), Color.White, 0f, new Vector2(8f, 16f), Math.Max(0.2f, scale) * 4f, flip ? SpriteEffects.FlipHorizontally : SpriteEffects.None, (position.Y + 128f + 1f) / 10000f);
				}
				else if ((bool)magmaSprite)
				{
					...
					b.Draw(Sprite.Texture, getLocalPosition(Game1.viewport) + new Vector2(32 + Game1.random.Next(-6, 7), 32 + Game1.random.Next(-6, 7)) + vector4, Game1.getSourceRectForStandardTileSheet(Sprite.Texture, num3 * 7 + (int)(Game1.currentGameTime.TotalGameTime.TotalMilliseconds % 490.0 / 70.0), 16, 16), Color.Red * 0.44f, 0f, new Vector2(8f, 16f), Math.Max(0.2f, scale) * 4f, flip ? SpriteEffects.FlipHorizontally : SpriteEffects.None, 0.9955f);
					b.Draw(Sprite.Texture, getLocalPosition(Game1.viewport) + new Vector2(32 + Game1.random.Next(-6, 7), 32 + Game1.random.Next(-6, 7)) + vector4, Game1.getSourceRectForStandardTileSheet(Sprite.Texture, num3 * 7 + (int)(Game1.currentGameTime.TotalGameTime.TotalMilliseconds % 490.0 / 70.0), 16, 16), Color.Yellow * 0.44f, 0f, new Vector2(8f, 16f), Math.Max(0.2f, scale) * 4f, flip ? SpriteEffects.FlipHorizontally : SpriteEffects.None, 0.9975f);
					for (int num4 = previousPositions.Count - 1; num4 >= 0; num4 -= 2)
					{
						b.Draw(Sprite.Texture, new Vector2(previousPositions[num4].X - (float)Game1.viewport.X, previousPositions[num4].Y - (float)Game1.viewport.Y + (float)yJumpOffset) + drawOffset + new Vector2(32f, 32f) + vector4, Game1.getSourceRectForStandardTileSheet(Sprite.Texture, num3 * 7 + (int)(Game1.currentGameTime.TotalGameTime.TotalMilliseconds % 490.0 / 70.0), 16, 16), Color.White * (0f + 0.125f * (float)num4), 0f, new Vector2(8f, 16f), Math.Max(0.2f, scale) * 4f, flip ? SpriteEffects.FlipHorizontally : SpriteEffects.None, 0.9985f);
					}
					b.Draw(Sprite.Texture, getLocalPosition(Game1.viewport) + new Vector2(32f, 32f) + vector4, Game1.getSourceRectForStandardTileSheet(Sprite.Texture, num3 * 7 + (int)(Game1.currentGameTime.TotalGameTime.TotalMilliseconds % 490.0 / 70.0), 16, 16), Color.White, 0f, new Vector2(8f, 16f), Math.Max(0.2f, scale) * 4f, flip ? SpriteEffects.FlipHorizontally : SpriteEffects.None, 1f);
				}
				else
				{
					...
					b.Draw(Game1.objectSpriteSheet, getLocalPosition(Game1.viewport) + new Vector2(32 + Game1.random.Next(-6, 7), 32 + Game1.random.Next(-6, 7)) + vector5, Game1.getSourceRectForStandardTileSheet(Game1.objectSpriteSheet, 103, 16, 16), Color.Violet * 0.44f, 0f, new Vector2(8f, 16f), Math.Max(0.2f, scale) * 4f, flip ? SpriteEffects.FlipHorizontally : SpriteEffects.None, (position.Y + 128f - 1f) / 10000f);
					b.Draw(Game1.objectSpriteSheet, getLocalPosition(Game1.viewport) + new Vector2(32 + Game1.random.Next(-6, 7), 32 + Game1.random.Next(-6, 7)) + vector5, Game1.getSourceRectForStandardTileSheet(Game1.objectSpriteSheet, 103, 16, 16), Color.Lime * 0.44f, 0f, new Vector2(8f, 16f), Math.Max(0.2f, scale) * 4f, flip ? SpriteEffects.FlipHorizontally : SpriteEffects.None, (position.Y + 128f) / 10000f);
					b.Draw(Game1.objectSpriteSheet, getLocalPosition(Game1.viewport) + new Vector2(32f, 32f) + vector5, Game1.getSourceRectForStandardTileSheet(Game1.objectSpriteSheet, 103, 16, 16), new Color(255, 50, 50), 0f, new Vector2(8f, 16f), Math.Max(0.2f, scale) * 4f, flip ? SpriteEffects.FlipHorizontally : SpriteEffects.None, (position.Y + 128f + 1f) / 10000f);
				}
			}
			else
			{
		...
		public override void behaviorAtGameTick(GameTime time)
		{
			...
			if (canLunge.Value)
			{
				...
				if (lungeTimer > 0)
				{
					...
					Vector2 vector = Utility.PointToVector2(base.Player.GetBoundingBox().Center) - Utility.PointToVector2(GetBoundingBox().Center);
